...
(1, 'لیست مالکین', 'users_list'),
(2, 'ویرایش مالکین', 'users_edit'),
(3, 'تغییر سطح دسترسی', 'change_privileges'),
(4, 'ثبت نام مالکین', 'signup_users'),
(5, 'لیست واحد ها', 'unit_list'),
(6, 'اضافه کردن قرارداد', 'add_contract');
...
`id` int(11) NOT NULL,
  ...
  `masahat_sabti` varchar(255) DEFAULT NULL,
  `kontori_marboote` varchar(255) DEFAULT NULL,
  `shomare_badane_kontor` varchar(255) DEFAULT NULL,
  `shomare_parvande` varchar(255) DEFAULT NULL,
  `noe_faaz` varchar(255) DEFAULT NULL,
  `noe_karbari` varchar(255) DEFAULT NULL,
...
INSERT INTO `vahed` (`id`, `radif`, `pelak_sabti`, `pelak_abi`, `address`, `masahat_sabti`, `kontori_marboote`, `shomare_badane_kontor`, `shomare_parvande`, `noe_faaz`, `noe_karbari`, `ab`, `parking`, `gaz`, `telephone`, `sanad`) VALUES
